...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			paperImage = new ImageIcon(getClass().getResource("cool Origami art16.jpg"));
			scissorsImage = new ImageIcon(getClass().getResource("salls.jpg"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        opponentSelection = gen.nextInt(3);
